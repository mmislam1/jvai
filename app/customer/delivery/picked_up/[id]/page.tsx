...
export default function OrderTrackingPage({ params }: OrderTrackingPageProps) {
    ...
    const statusSteps = [
        { key: 'placed', label: 'Order Placed', description: 'Your order has been confirmed', completed: true },
        { key: 'picked_up', label: 'Picked Up', description: "Your order is on it's way", completed: true },
        { key: 'on_way', label: 'On the Way', description: 'The driver is heading to you', completed: false },
        { key: 'delivered', label: 'Delivered', description: 'Take your parts', completed: false },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-4xl mx-auto px-4 py-8">
                ...
                {/* Map Section */}
                <div className="relative w-full h-64 md:h-80 bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl overflow-hidden shadow-lg mb-8">
                ...
                <div className="bg-white rounded-2xl shadow-md p-6 md:p-8 border border-gray-100">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-1 mt-1">
                                    <span className="text-sm text-gray-600">{order.driver.vehicle}</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <button className="flex-1 md:flex-none bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-3 px-6 rounded-lg transition flex items-center justify-center gap-2">
