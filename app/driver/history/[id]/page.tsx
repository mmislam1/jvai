...
import { Star, ArrowLeft, HomeIcon, DropletIcon, PinIcon, MapPin, PhoneCallIcon, MessageSquare } from "lucide-react";
            ...
            <div className=" mx-auto">
                ...
                <div className="flex flex-col items-center justify-center bg-white mt-6 md:mt-10 p-6 sm:p-8  mt-8 border-t border-gray-200 ">
                    <div className="w-full flex flex-col items-center justify-between gap-6">
                        {/* Client Info */}
                        <div className="flex flex-col items-center gap-4 w-full md:w-2xl md:px-20">
                            {/* Avatar */}
